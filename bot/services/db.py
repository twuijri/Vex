...
from bot.config_loader import get_mongo_uri
import logging
import dns.resolver
...
class Database:
    ...
    async def connect(self):
        ...
        try:
            ...
            self.db = self.client.get_default_database("boter_db")
    ...
    async def init_database(self):
        ...
        """
        try:
            # 1. Groups Collection Index
            # Drop potentially conflicting indexes
            try:
                await self.db.groups.drop_index("id_1")
            except:
                pass
            try:
                await self.db.groups.drop_index("chat_id_1")
            except:
                pass
            ...
            # Users rely on 'id' which is correct (Telegram User ID)
